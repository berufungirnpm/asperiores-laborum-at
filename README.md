[![npm](https://img.shields.io/npm/v/@berufungirnpm/asperiores-laborum-at.svg)](https://www.npmjs.com/package/@berufungirnpm/asperiores-laborum-at) ![downloads](https://img.shields.io/npm/dt/@berufungirnpm/asperiores-laborum-at.svg) [![CI](https://github.com/berufungirnpm/asperiores-laborum-at/actions/workflows/ci.yml/badge.svg)](https://github.com/berufungirnpm/asperiores-laborum-at/actions)
...
- Install by executing `npm install @berufungirnpm/asperiores-laborum-at` or `yarn add @berufungirnpm/asperiores-laborum-at`.
- Import by adding `import DatePicker from '@berufungirnpm/asperiores-laborum-at'`.
...
[Online demo](https://projects.wojtekmaj.pl/@berufungirnpm/asperiores-laborum-at/) is also available!
...
Add React-Date-Picker to your project by executing `npm install @berufungirnpm/asperiores-laborum-at` or `yarn add @berufungirnpm/asperiores-laborum-at`.
...
import DatePicker from '@berufungirnpm/asperiores-laborum-at';
...
```ts
import '@berufungirnpm/asperiores-laborum-at/dist/DatePicker.css';
...
| className            | Class name(s) that will be added along with `"@berufungirnpm/asperiores-laborum-at"` to the main React-Date-Picker `<div>` element.                                                                                                                                                                                                                           | n/a                                   | <ul><li>String: `"class1 class2"`</li><li>Array of strings: `["class1", "class2 class3"]`</li></ul>                                                                                                                 |
...
Thank you to all our sponsors! [Become a sponsor](https://opencollective.com/@berufungirnpm/asperiores-laborum-at#sponsor) and get your image on our README on GitHub.

<a href="https://opencollective.com/@berufungirnpm/asperiores-laborum-at#sponsors" target="_blank"><img src="https://opencollective.com/@berufungirnpm/asperiores-laborum-at/sponsors.svg?width=890"></a>

### Backers

Thank you to all our backers! [Become a backer](https://opencollective.com/@berufungirnpm/asperiores-laborum-at#backer) and get your image on our README on GitHub.

<a href="https://opencollective.com/@berufungirnpm/asperiores-laborum-at#backers" target="_blank"><img src="https://opencollective.com/@berufungirnpm/asperiores-laborum-at/backers.svg?width=890"></a>

### Top Contributors

Thank you to all our contributors that helped on this project!

![Top Contributors](https://opencollective.com/@berufungirnpm/asperiores-laborum-at/contributors.svg?width=890&button=false)
